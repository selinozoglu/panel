...
if (document.getElementById("chart-consumption")) {
  let ctx1 = document.getElementById("chart-consumption").getContext("2d");
...
if (document.getElementById("chart-cons-week")) {
  let ctx = document.getElementById("chart-cons-week").getContext("2d");
...
if (document.getElementById("chart-line-1")) {
  let ctx1 = document.getElementById("chart-line-1").getContext("2d");
...
if (document.getElementById("chart-line-projects")) {
  let ctx1 = document.getElementById("chart-line-projects").getContext("2d");
...
if (document.getElementById("chart-bar-projects")) {
  let ctx2 = document.getElementById("chart-bar-projects").getContext("2d");
...
if (document.getElementById("chart-widgets-2")) {
  let ctx2 = document.getElementById("chart-widgets-2").getContext("2d");
...
if (document.getElementById("chart-line-widgets")) {
  ...
  let charts = document.querySelectorAll("#chart-line-widgets");
  charts.forEach(chart => {
    let ctx3 = chart.getContext("2d");
  // let ctx3 = document.getElementById("chart-line-widgets").getContext("2d");
...
let ctx1 = document.getElementById("chart-widgets-1").getContext("2d");
  ...
  if(document.getElementById("chart-line-3")){
    ...
    let ctx1 = document.getElementById("chart-line-3").getContext("2d");
  ...
  if (document.getElementById("chart-line-traffic")) {
    let ctx1 = document.getElementById("chart-line-traffic").getContext("2d");
  ...
  if (document.getElementById("chart-doughnut-referrals")) {
    let ctx2 = document.getElementById("chart-doughnut-referrals").getContext("2d");
  ...
  if (document.getElementById("chart-pie")) {
    let ctx2 = document.getElementById("chart-pie").getContext("2d");
    // Pie chart
    new Chart(ctx2, {
      type: "pie",
      data: {
  ...
  if (document.getElementById("chart-line-ecommerce")) {
    let ctx1 = document.getElementById("chart-line-ecommerce").getContext("2d");
  ...
  if (document.getElementById("chart-line-ecommerce")) {
    let ctx3 = document.getElementById("chart-bar").getContext("2d");
